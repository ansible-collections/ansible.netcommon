...
TESTS = [
    ...
    "{{ '10.1.1.0/24' is ansible.netcommon.subnet '10.0.0.0/8' }}",
    "{{ '192.168.1.0/24' is not ansible.netcommon.subnet '10.0.0.0/8' }}",
    "{{ '10.0.0.0/8' is ansible.netcommon.supernet '10.1.1.0/24' }}",
