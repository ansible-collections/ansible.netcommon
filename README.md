...
[ansible.netcommon.test_httpapi](https://github.com/ansible-collections/ansible.netcommon/blob/main/docs/ansible.netcommon.test_httpapi_connection.rst)|Use httpapi to run command on network appliances
